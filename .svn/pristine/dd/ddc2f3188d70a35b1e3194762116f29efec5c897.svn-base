...
var page = (function(window, document, $, M, undefined) {
        ...
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                $.each(receivedData.ListData, function(index,rowData){
                    ...
                    // TM 중복 스캔 방지
                    $("#list_pd_105 .tableCont").each(function() {
                    ...
                    if(!exists){
                        ...
                        $("#list_pd_105_head").removeClass("blind");
                        $("#list_pd_105").prepend(tag);
    ...
    // PR_PDA_PD_105_C1 호출 및 저장
    var save = function() {
        saveflag = true;
        networkManager.httpSend({
            server: saveUserCo,
            path: 'api/PR_PDA_PD_105_C1.do',
            data: {
                'param1': C1_LIST
            },
            success: function(receivedData, setting) {
    ...
    var clear = function() {
        $("#list_pd_105").html("");
        $("#list_pd_105_head").addClass("blind");
