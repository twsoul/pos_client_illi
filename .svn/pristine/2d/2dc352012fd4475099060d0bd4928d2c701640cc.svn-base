...
var page = (function(window, document, $, M, undefined) {
    ...
    var save = function() {
        ...
        $("#list_kd_150 .tableCont").each(function() {
            C1_LIST.push({"COPORATE_CD":getCORP_CD, "PLANT_CD":$("#selPLANT").val(), "LOGI_CD":$("#selLOGI").val(), "CASE_NO":case_bar, "BLNO":bl_no, "CONT_NO":cont_no, "BOX_NO":$(this).find(".BOX_NO").text(), "BAR_QTY":parseInt($(this).find(".SCAN_QTY").text()), "SCAN_QTY":parseInt($(this).find(".DIV_QTY").val()), "USER_ID":getUSER_ID, "USER_NM":getUSER_NM, "RTN_MSG":""});
        });
