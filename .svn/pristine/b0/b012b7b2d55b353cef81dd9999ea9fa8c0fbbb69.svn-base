...
var page = (function(window, document, $, M, undefined) {
    ...
    var save = function() {
        ...
        $("#list_st_140 .tableCont").each(function() {
            C1_LIST.push({"COPORATE_CD":getCORP_CD, "PLANT_CD":$("#selPLANT").val(), "BOX_NO":$(this).find(".BOX_NO").text(), "USER_ID":getUSER_ID, "USER_NM":getUSER_NM, "RTN_MSG":""});
        });

        networkManager.httpSend({
            server: saveUserCo,
            path: 'api/PR_PDA_ST_140_C1.do',
            data: {
                'param1': C1_LIST
            },
            success: function(receivedData, setting) {
    ...
    var clear = function() {
        $("#list_st_140").html("");
        $("#list_st_140_head").addClass("blind");
