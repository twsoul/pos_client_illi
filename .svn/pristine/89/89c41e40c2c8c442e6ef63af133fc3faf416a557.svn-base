...
var page = (function(window, document, $, M, undefined) {
        ...
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                $.each(receivedData.ListData, function(index,rowData){
                    ...
                    // TM 중복 스캔 방지
                    $("#list_kd_253 .tableCont").each(function() {
                    ...
                    if(!exists){
                        ...
                        $("#list_kd_253_head").removeClass("blind");
                        $("#list_kd_253").prepend(tag);
    ...
    var clear = function() {
        $("#list_kd_253").html("");
        $("#list_kd_253_head").addClass("blind");
