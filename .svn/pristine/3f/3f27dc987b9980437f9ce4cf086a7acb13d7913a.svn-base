...
var page = (function(window, document, $, M, undefined) {
    ...
    var CaseNoScan = function(caseno) {
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                // CASE 중복 스캔 방지
                $("#list_ot_045 .tableCont").each(function() {
                ...
                $("#list_ot_045_head").removeClass("blind");
    ...
    var clear = function() {
        saveflag = false;
        $("#list_ot_045").html("");
        $("#list_ot_045_head").addClass("blind");
        $("#inpBoxQty").text("0");
        $("#inpBoxQty2").text("0");
