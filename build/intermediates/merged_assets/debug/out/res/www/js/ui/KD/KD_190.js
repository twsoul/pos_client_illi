...
var page = (function(window, document, $, M, undefined) {
    ...
    var CaseNoScan = function(casebarno) {
        ...
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                $("#list_kd_190_head").removeClass("blind");
    ...
    var save = function() {
        ...
        $("#list_kd_190 .tableCont").each(function() {
    ...
    var clear = function() {
        $("#list_kd_190").html("");
        $("#list_kd_190_head").addClass("blind");
