function InSPopup(opts){
							...
							+"<div class=\"pop_cont\">"
								...
								+"<div class=\"box_inner\">"
								    ...
								    +"<div class=\"opt_input\">"
                                        ...
                                        +"<p class=\"inputBox_outline\" style=\"background-color:#fff;\"><input type=\"{{TYPE}}\" onkeydown=\"if(event.keyCode == 13) this.blur();\"></p>"
                                    +"</div>"
                                    +"<div class=\"opt_select\">"
                                        +"<p class=\"lineHead\">{{LABEL3}}</p>"
                                        +"<p class=\"selectBox adjLayout\"><select class=\"select_area\"></select></p>"
                                    +"</div>"
								+"</div>"
								+"<div class=\"btn_area\">"
	...
	var label3 = opts.label3 == undefined ? "" : opts.label3;
	...
	this.init = function() {
		...
		$("#" + id).on("click", ".btn_area .btn_confirm", function(){
            ...
            var code = $("#" + id + " .select_area option:selected").val();
