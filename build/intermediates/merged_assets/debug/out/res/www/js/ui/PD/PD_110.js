...
var page = (function(window, document, $, M, undefined) {
    ...
    var TmScan = function(tm_no){
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                // TM 중복 스캔 방지
                $("#list_pd_110 .tableCont").each(function() {
                ...
                $("#list_pd_110_head").removeClass("blind");
                $("#list_pd_110").prepend(tag);
    ...
    // PR_PDA_PD_110_C1 호출 및 저장
    var save = function() {
        saveflag = true;
        networkManager.httpSend({
            server: saveUserCo,
            path: 'api/PR_PDA_PD_110_C1.do',
            data: {
                'param1': C1_LIST
            },
            success: function(receivedData, setting) {
    ...
    var clear = function() {
        $("#list_pd_110").html("");
        $("#list_pd_110_head").addClass("blind");
