...
var page = (function(window, document, $, M, undefined) {
    ...
    var TmScan = function(tm_no){
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                // TM 중복 스캔 방지
                $("#list_kd_257 .tableCont").each(function() {
                ...
                $("#list_kd_257_head").removeClass("blind");
                $("#list_kd_257").prepend(tag);

                C1_LIST.push({"COPORATE_CD":getCORP_CD, "PLANT_CD":$("#selPLANT").val(), "TM_NO":tm_no, "USER_ID":getUSER_ID, "RTN_MSG":""});
                $("#inputScan").focus();
            }
        });
    }
    ...
    var clear = function() {
        $("#list_kd_257").html("");
        $("#list_kd_257_head").addClass("blind");
