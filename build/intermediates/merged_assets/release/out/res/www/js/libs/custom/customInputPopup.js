							...
							+"<div class=\"pop_cont\">"
								...
								+"<div class=\"box_inner\">"
								    +"<div class=\"opt_input\">"
                                        ...
                                        +"<p class=\"inputBox_outline\" style=\"color:#fff; padding-left:3%;\">{{VALUE}}</p>"
                                    +"</div>"
								    +"<div class=\"opt_input\">"
								        +"<p class=\"lineHead\">{{LABEL2}}</p>"
								        +"<p class=\"inputBox_outline\" style=\"background-color:#fff; border:1px solid #666;\"><input type=\"{{TYPE}}\" autocapitalize=\"characters\" onkeydown=\"if(event.keyCode == 13) this.blur();\"></p>"
								    +"</div>"
								+"</div>"
								+"<div class=\"btn_area\">"
