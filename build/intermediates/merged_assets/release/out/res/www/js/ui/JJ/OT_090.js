...
var page = (function(window, document, $, M, undefined) {
    ...
    var BoxNoScan = function(box_bar_no) {
        networkManager.httpSend({
            server: saveUserCo,
            path: 'api/OT_090_S1.do',
            data: {
                'BOX_BAR_NO': box_bar_no,
                'TO_PLANT_CD': $("#selTOPLANT").val(),
                'TO_LOC_TP': $("#selTOLOCTP").val()
            },
            success: function(receivedData, setting) {
                ...
                // 스캔시 플랜트와 저장위치, 이동플랜트와, 이동저장위치 선택 불가
                ...
                $("#list_ot_090_head").removeClass("blind");
                var exists = false;
                var tag = "";
                var template = $("#ListTemplate").html();

                $("#list_ot_090 .tableCont").each(function() {
    ...
    var clear = function() {
        $("#list_ot_090").html("");
        $("#list_ot_090_head").addClass("blind");
