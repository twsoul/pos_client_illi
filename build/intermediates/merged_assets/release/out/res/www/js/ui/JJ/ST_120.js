...
var page = (function(window, document, $, M, undefined) {
    ...
    var CaseNoScan = function(casebarno) {
        ...
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                $("#list_st_120_head").removeClass("blind");
    ...
    var save = function() {
        ...
        $("#list_st_120 .tableCont").each(function() {
    ...
    var clear = function() {
        $("#list_st_120").html("");
        $("#list_st_120_head").addClass("blind");
