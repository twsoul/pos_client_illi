...
var page = (function(window, document, $, M, undefined) {
    ...
    var TMScan = function(TMBarCode){
        ...
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                $("#list_pd_077_head").removeClass("blind");
                ...
                $("#list_pd_077").prepend(tag);

                C1_LIST.push({"COPORATE_CD":getCORP_CD,"PLANT_CD":getWERKS, "LOC_TP":rowData.OT_LOC_TP, "VENDOR_CD":rowData.VENDOR_CD, "SERIAL_NO":rowData.SERIAL_NO, "TM_NO":rowData.TM_NO, "SAVE_LOC":rowData.SAVE_LOC, "PART_CD":PART_CD, "USER_ID":getUSER_ID, "RTN_MSG":""});
    ...
    var clear = function() {
        ...
        $("#list_pd_077").html("");
        $("#list_pd_077_head").addClass("blind");
