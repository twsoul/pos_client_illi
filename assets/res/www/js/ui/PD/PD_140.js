...
var page = (function(window, document, $, M, undefined) {
    ...
    var TmScan = function(tm_no){
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                // TM 중복 스캔 방지
                $("#list_pd_140 .tableCont").each(function() {
                ...
                if(!exists){
                    ...
                    $("#list_pd_140_head").removeClass("blind");
                    $("#list_pd_140").prepend(tag);
                    $("#selPLANT").attr("disabled",true);
                    $("#selLOCTP").attr("disabled",true);
                    C1_LIST.push({"COPORATE_CD":getCORP_CD, "PLANT_CD":$("#selPLANT").val(), "LOC_TP":$("#selLOCTP").val(), "TM_NO":tm_no, "USER_ID":getUSER_ID, "RTN_MSG":""});
                }
                if(exists == true){
    ...
    var clear = function() {
        $("#list_pd_140").html("");
        $("#list_pd_140_head").addClass("blind");
