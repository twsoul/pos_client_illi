...
var page = (function(window, document, $, M, undefined) {
    ...
    var PalletScan = function(plt_no){
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                if (rowData.PLT_LOC_CD != "A01" && rowData.PLT_LOC_CD != "A02" && rowData.PLT_LOC_CD != "A03") {
                ...
                if(rowData.TM_NO != null){
                    ...
                    $("#list_pd_120_head").removeClass("blind");
                    $("#list_pd_120").prepend(tag);
                }
                $("#inputScan").focus();
            }
        });
    ...
    var TmScan = function(tm_no){
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                // TM 중복 스캔 방지
                $("#list_pd_120 .tableCont").each(function() {
    ...
    var clear = function() {
        $("#list_pd_120").html("");
        $("#list_pd_120_head").addClass("blind");
        $("#txtPALLET").text("");
        $("#txtPART_CD").text("");
        $("#txtPACK_QTY").text("");
