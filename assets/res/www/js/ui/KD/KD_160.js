...
var page = (function(window, document, $, M, undefined) {
    ...
    var save = function() {
        ...
        C1_LIST.push({"COPORATE_CD":getCORP_CD, "PLANT_CD":$("#selPLANT").val(), "USER_ID":getUSER_ID, "RTN_MSG":""});
        $("#list_kd_160 .tableCont").each(function() {
            C2_LIST.push({"COPORATE_CD":getCORP_CD, "PLANT_CD":$("#selPLANT").val(), "LOC_TP":$("#selLOCTP").val(), "LOGI_CD":$("#selLOGI").val(), "BOX_NO":$(this).find(".BOX_NO").text(), "BAR_QTY":parseInt($(this).find(".SCAN_QTY").text()), "SCAN_QTY":parseInt($(this).find(".DIV_QTY").val()), "USER_ID":getUSER_ID, "USER_NM":getUSER_NM, "RTN_MSG":""});
        });
