...
var page = (function(window, document, $, M, undefined) {
    ...
    var PalletScan = function(plt_no) {
        networkManager.httpSend({
            ...
            success: function(receivedData, setting) {
                ...
                if (rowData.INSERT_FLAG == "Y") {
                    popupManager.instance($("[data-lng='MSG.0000000672']").text(), {showtime:"LONG"}); // 이미 포장 공정에 투입된 팔레트 입니다
                    $("#inputScan").focus();
                    return;
                }
                var exists = false;
                ...
                $("#list_kd_210_head").removeClass("blind");
                ...
                $("#list_kd_210 .tableCont").each(function() {
    ...
    var clear = function() {
        ...
        $("#list_kd_210").html("");
        $("#list_kd_210_head").addClass("blind");
        $("#inpBoxQty").text("0");
